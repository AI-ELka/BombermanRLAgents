from agent_code.dql_large.utils import *
import events as e
import agent_code.dql_large.own_events as own_e
...
GAME_REWARDS = {
        ...
        own_e.CLOSER_TO_COIN: 1.05,
        own_e.AWAY_FROM_COIN: -1.15,
        own_e.CLOSER_TO_CRATE: 0.1,
        own_e.AWAY_FROM_CRATE: -0.05,
        own_e.WAITED_NECESSARILY: 0.5,
        own_e.WAITED_UNNECESSARILY: -3,
        own_e.CLOSER_TO_PLAYERS: 1,#0.08,
