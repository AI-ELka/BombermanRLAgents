...
from agent_code.dql_large.feature_extraction import FEATURE_VECTOR_SIZE
...
class DeepQLearningAgent:
  def __init__(self,
    ...
    self.q_network = QNetwork(
      n_observations=FEATURE_VECTOR_SIZE, # features vector has shape (FEATURE_VECTOR_SIZE, )
