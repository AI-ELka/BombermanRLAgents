...
from agent_code.dql_large.feature_extraction import state_to_large_features
from agent_code.dql_large.add_own_events import add_own_events_q_learning, GAME_REWARDS
from agent_code.dql_large.deep_q_learning import *
...
def game_events_occurred(self, old_game_state: dict, self_action: str, new_game_state: dict, events: List[str]):
    ...
    old_feature_state = state_to_large_features(old_game_state, num_coins_already_discovered)#.to(self.device)
    new_feature_state = state_to_large_features(new_game_state, num_coins_already_discovered)#.to(self.device)
...
def end_of_round(self, last_game_state: dict, last_action: str, events: List[str]):
    ...
    old_feature_state = state_to_large_features(last_game_state, num_coins_already_discovered)#.to(self.device)
